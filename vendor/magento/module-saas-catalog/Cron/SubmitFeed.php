...
use Magento\SaaSCatalog\Model\FeedRegistry;
use Magento\SaaSCatalog\Model\Http\Command\SubmitFeed as HttpCommandSubmitFeed;
use Magento\ServicesConnector\Model\Environment;
use Psr\Log\LoggerInterface;

/**
 * Class to execute submitting product feed
 */
class SubmitFeed
{
