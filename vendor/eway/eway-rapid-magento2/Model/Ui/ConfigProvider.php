<?php
namespace Eway\EwayRapid\Model\Ui;
...
class ConfigProvider implements \Magento\Checkout\Model\ConfigProviderInterface
{
    ...
    protected function prepareTokenList() // @codingStandardsIgnoreLine
    {
        ...
        foreach ($this->tokenManager->getActiveTokenList() as $id => $token) {
            /** @var \Eway\EwayRapid\Model\Customer\Token $token */
            $tokenList[$id] = [
                'token_id'  => $id,
                'card'      => $token->getCard(),
    ...
    /**
     * @return \Eway\EwayRapid\Model\Ui\MethodSpecificConfigInterface
     */
