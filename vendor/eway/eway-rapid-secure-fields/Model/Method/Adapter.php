<?php
namespace Eway\SecureFields\Model\Method;
...
class Adapter extends \Magento\Payment\Model\Method\Adapter
{
    ...
    public function assignData(\Magento\Framework\DataObject $data)
    {
        ...
        $addtionalFields = [Config::TOKEN_ACTION, Config::SECURED_CARD_DATA, Config::TOKEN_ID];
    ...
    public function isAvailable(CartInterface $quote = null)
    {
        ...
        $result = $this->config->getValue('mode', $storeId) == Mode::SANDBOX ?
            !empty($this->config->getValue('sandbox_public_api_key', $storeId)) :
            !empty($this->config->getValue('live_public_api_key', $storeId));
